<?php
	...
	include_once( MAIN_CLASS_PATH."common/class.gddetector.php" );
	...
	class GalleryGDResizer  
	{
		 ...
		 */
        function generate( $imagetothumb , $outFile, $width, $height )
        {
        	//
        ...
        function imgSave( $save = "" )
        {
			...
			//$config =& Config::getConfig();
			//if( $this->isGD2Available())
			//	$resizeMode = 1; $config->getValue( "thumbnail_generator_use_smoothing_algorithm", GD_RESIZER_NO_SMOOTHING_MODE );
			//else
