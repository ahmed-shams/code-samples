...
/*	
 ...
 @param srting $AttachFileName : the file name to be given for the File in Mail
 */

function Attach( $filename, $filetype = "", $disposition = "inline",$AttachFileName )
{
...
//	$this->xheaders['To'] = implode( ", ", $this->sendto );
	...
	if( $this->charset != "" ) {
		$this->xheaders["Mime-Version"] = "1.0";
		$this->xheaders["Content-Type"] = $this->HeaderType."; charset=$this->charset";
...
//	print $this->fullBody;
//	print "Email : ". $this->strTo ."<BR>";
//	print "Subject : ". $this->xheaders['Subject'] . "<BR>";
//	print "Headers : ". $this->headers. "<BR>";	
...
function ValidEmail($address)
{
	...
	if(ereg( "^[^@  ]+@([a-zA-Z0-9\-]+\.)+([a-zA-Z0-9\-]{2}|net|com|gov|mil|org|edu|int|info)\$",$address) ) 
 		return true;
 	else
 		return false;
}
