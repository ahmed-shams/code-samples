<?php /* Smarty version 2.6.9, created on 2008-02-08 02:59:19
         compiled from documentwisereport.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'documentwisereport.tpl', 214, false),)), $this); ?>
<?php echo '
...
')" style="cursor:pointer" class="WhiteFont" ><span class="WhiteFont"> Users Assigned </span></a></td>
...
')" class="WhiteFont" style="cursor:pointer"><span class="WhiteFont">Users Read</span> </a></td>
        <td width="14%" style="padding-left:5px "nowrap><?php if ($this->_tpl_vars['type'] == 'asc'):  $this->assign('SortType', 'desc'); ?> <?php else:  $this->assign('SortType', 'asc'); ?>
          <?php endif; ?><a onClick="getCategorySort('Status','<?php echo $this->_tpl_vars['SortType']; ?>
')" class="WhiteFont" style="cursor:pointer"><span class="WhiteFont">Users Unread</span></a> </td>
      </tr>
      <?php unset($this->_sections['val']);
$this->_sections['val']['name'] = 'val';
$this->_sections['val']['loop'] = is_array($_loop=$this->_tpl_vars['docsList']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?> <?php if ($this->_sections['val']['iteration'] % 2 == 0): ?> <?php $this->assign('ClassName', 'GridCell1'); ?> <?php else: ?> <?php $this->assign('ClassName', 'GridCell2'); ?> <?php endif; ?>
      <?php if ($this->_tpl_vars['docsList'][$this->_sections['val']['index']]['Status'] == 'Active'): ?>
      <?php $this->assign('StatusFont', 'GreenFont'); ?>
      <?php elseif ($this->_tpl_vars['docsList'][$this->_sections['val']['index']]['Status'] == 'Inactive'): ?>
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['documentname'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
 </td>
        <td style="padding-left:5px;" align="center"><img title="View <?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['documentname'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
 Assigned Users" src="images/user-assigned.gif" onclick="ShowHideEventform('<?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['documentname'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
 Assigned Users','<?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['UserName'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
')" /> </td>
        <td style="padding-left:5px;" class="GreenFont" align="center"><img src="images/user-read.gif" title="View <?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['documentname'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
 Users who read" onclick="ShowHideEventform('<?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['documentname'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
 Users who read','<?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['ReadUserfullName'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
')" /></td>
        <td style="padding-left:5px;" class="RedFont" align="center"><img src="images/user-unread.gif" title="View <?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['documentname'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
 Users who unread" onclick="ShowHideEventform('<?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['documentname'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
 Users who unread','<?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['UnreadUserfullName'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
')" /></td>
      </tr>
      <?php endfor; else: ?>
      <tr>
...
?>
          <tr>
		  	<td width="14%" nowrap="nowrap"><font class="Nametxt"><?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['documentname'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</font></td>
			<td width="28%"><font class="Orangefnttxt"><?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['UserName'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</font></td>
			<td width="22%"><font class="greenfnttxt"><?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['ReadUserfullName'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</font></td>
			<td width="36%"><font class="redfnttxt"><?php echo ((is_array($_tmp=$this->_tpl_vars['docsList'][$this->_sections['val']['index']]['UnreadUserfullName'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</font></td>
          </tr>
		  <?php endfor; endif; ?>
        </table>
