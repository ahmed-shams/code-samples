<?php /* Smarty version 2.6.9, created on 2008-01-25 13:10:33
...
<link href="<?php echo $this->_tpl_vars['SiteGlobalPath']; ?>
siteadmin/css/Main.css" rel="stylesheet" type="text/css">
					...
					<tr> 
						<td width="338" height="176" valign="top" background="images/index_04.gif">
							<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
								...
								<tr> 
									<td height="20" align="center" class="ErrorMsg"><?php echo $this->_tpl_vars['ErrMsg']; ?>
</td>
								</tr>
								<tr> 
