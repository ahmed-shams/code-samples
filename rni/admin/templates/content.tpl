              ...
              <dd> 
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr> 
                    ...
                    <td width="52%"><a href="userlist.php" class="DashFont">{$UserCount1}</a></td>
                  </tr>
                  <tr> 
                  ...
                  <tr> 
                    ...
                    <td><a href="userlist.php?account_status=Active" class="DashFont">{$ActiveUserlistCount}</a></td>
                  </tr>
                  <tr> 
                    <td colspan="3" height="10"></td>
                  </tr>				  
                  <tr> 
                    ...
                    <td><a href="userlist.php?account_status=InActive" class="DashFont">{$InActiveUserlistCount}</a></td>
                  </tr>
                  <tr> 
                    <td colspan="3">&nbsp;</td>
                  </tr>
              ...
              <dd> 
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr> 
                    ...
                    <td width="52%"><a href="grouplist.php" class="DashFont">{$GroupCount}</a></td>
                  </tr>
                  <tr> 
              ...
              <dd> 
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr> 
                    ...
                    <td width="52%"><a href="documentlist.php" class="DashFont">{$documentCount}</a></td>
                  </tr>
                  <tr> 
                    <td colspan="3" height="10"></td>
                  </tr>
              ...
              <dd> 
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr> 
                    ...
                    <td width="52%"><a href="list_news_letter.php" class="DashFont">{$totalnewsletter}</a></td>
                  </tr>
                  <tr> 
                    <td colspan="3" height="10"></td>
                  </tr>
