<?php /* Smarty version 2.6.9, created on 2008-01-25 22:18:38
         compiled from add_member.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'add_member.tpl', 112, false),)), $this); ?>
<?php echo '
						...
						<fieldset class="Fieldset" style="width:625px;"><legend>Member Details</legend>
							...
							<table width="99%"  border="0" cellspacing="2" cellpadding="8">
												<tr>
													...
													<td width="56%" class="ListCell"><input style="background-color:#ffffff" name="txtfirstname" id="txtfirstname" type="text"    class="featuredtxtbox"   value="<?php echo $this->_tpl_vars['txtusername']; ?>
" size="39"  ></td>		
												</tr>
												<tr>
													<td  width="31%" valign="top" class="text"><label for="txtRUserName">Last Name<span class="mand">*</span></label></td>
													<td width="56%" class="ListCell"><input style="background-color:#ffffff" name="txtlastname" id="txtlastname" type="text"    class="featuredtxtbox"   value="<?php echo $this->_tpl_vars['txtusername']; ?>
" size="39"  >	</td>				
												</tr>
							
												<tr>
													<td  width="31%" valign="top" class="text"><label for="txtRUserName">Username<span class="mand">*</span></label></td>
													<td width="56%" class="ListCell"><input style="background-color:#ffffff" name="txtusername" type="text"    class="featuredtxtbox"   value="<?php echo $this->_tpl_vars['txtusername']; ?>
" size="39"  id="txtusername">		</td>			
												</tr>
												...
												<tr>
													...
													<td width="56%" class="ListCell"><input style="background-color:#ffffff" name="txtemail" size="39" class="featuredtxtbox"  value="<?php echo $this->_tpl_vars['txtemail']; ?>
"  type="text" id="txtemail" /></td>		
												...
												<tr>
													...
													<td class="ListCell">
													  <select name="month" style="width:50px;" id="month" tabindex="13">
														<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['monthsList'],'selected' => $this->_tpl_vars['month']), $this);?>

													  </select>
													  <select name="day" style="width:50px;" id="day" tabindex="14">
														<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['daysList'],'selected' => $this->_tpl_vars['day']), $this);?>

													  </select>					
													  <select name="year" style="width:60px;" id="year" tabindex="15">
														<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['yearList'],'selected' => $this->_tpl_vars['year']), $this);?>
												...
												<tr>
													...
													<td class="ListCell">
														<input style="background-color:#ffffff" name="txtcity" type="text" class="featuredtxtbox"  value="<?php echo $this->_tpl_vars['txtcity']; ?>
" size="39"  id="txtcity">			
													</td>
												</tr>
												<tr>
													<td class="text" valign="top">State</td>
													  <td class="ListCell">
													  <!--<input style="background-color:#ffffff" name="txtstate" type="text" class="featuredtxtbox"  value="<?php echo $this->_tpl_vars['txtstate']; ?>
" size="39"  id="txtstate"  >-->	

													<select name="txtstate" id="txtstate" class="txtbox">
														<option value="0">Select</option>
		 												<?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['StateCode'],'output' => $this->_tpl_vars['StateName'],'selected' => $this->_tpl_vars['txtstate']), $this);?>
												...
												<tr>
													...
													<td class="ListCell">
														<input style="background-color:#ffffff" size="39" name="txtzip"  id="txtzip" value="<?php echo $this->_tpl_vars['txtzip']; ?>
"   class="featuredtxtbox"    type="text"/>
													</td>
												</tr>
