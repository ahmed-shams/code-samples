<?php /* Smarty version 2.6.9, created on 2008-01-29 07:30:31
         compiled from listdocumentsgridview.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'listdocumentsgridview.tpl', 27, false),array('modifier', 'truncate', 'listdocumentsgridview.tpl', 59, false),array('modifier', 'date_format', 'listdocumentsgridview.tpl', 62, false),)), $this); ?>
<?php echo '
...
$this->_sections['doc']['loop'] = is_array($_loop=$this->_tpl_vars['documentsList']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
						...
						<?php if ($this->_tpl_vars['DocStatus'] == $this->_tpl_vars['documentsList'][$this->_sections['doc']['index']]['Status']): ?>
						<tr class="<?php echo $this->_tpl_vars['rowcss']; ?>
"> 
							<td class="tableTd" style="cursor:pointer; text-decoration:underline;" title="View <?php echo $this->_tpl_vars['documentsList'][$this->_sections['doc']['index']]['documentname']; ?>
" onclick="Viewdetaileddocview('<?php echo $this->_tpl_vars['documentsList'][$this->_sections['doc']['index']]['id']; ?>
');"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['documentsList'][$this->_sections['doc']['index']]['documentname'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 40, "...", false) : smarty_modifier_truncate($_tmp, 40, "...", false)); ?>
</td>
							<td class="tableTd" ><?php echo ((is_array($_tmp=$this->_tpl_vars['documentsList'][$this->_sections['doc']['index']]['doc_OriginalName'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)); ?>
</td>
							<td class="tableTd"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['documentsList'][$this->_sections['doc']['index']]['doc_description'])) ? $this->_run_mod_handler('stripslashes', true, $_tmp) : stripslashes($_tmp)))) ? $this->_run_mod_handler('truncate', true, $_tmp, 80) : smarty_modifier_truncate($_tmp, 80)); ?>
</td>
							<td class="tableTd"><?php echo ((is_array($_tmp=$this->_tpl_vars['documentsList'][$this->_sections['doc']['index']]['created_on'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%m-%d-%Y") : smarty_modifier_date_format($_tmp, "%m-%d-%Y")); ?>
</td>
							<td class="tableTd"><?php echo $this->_tpl_vars['documentsList'][$this->_sections['doc']['index']]['Status']; ?>
</td>
						 </tr>
						 <?php endif; ?>	
						 <?php else: ?>
