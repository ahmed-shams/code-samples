...
<tr>
			...
			<tr>
			  ...
			  <tr>
				<td  colspan="2" align="center"><span class="ErrorMsg" id="ForgotPwdErrorMsg_01">{$strMsg}</span></td>
			  </tr>
			...
			<tr>
				...
				<input style="background-color:#ffffff" name="txt_username" type="text"    class="textbox1" value="{$txt_username}"  size="39"  id="txt_username">
